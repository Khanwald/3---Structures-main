...
var caleb = User(name: "Caleb", age: 17, height: 5.10, weight: 205, activityLevel: 4)

print("\(caleb.name) \(caleb.age) \(caleb.height) \(caleb.weight) \(caleb.activityLevel)")
/*:
